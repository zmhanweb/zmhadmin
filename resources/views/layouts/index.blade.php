...
<head lang="en">
  <meta charset="UTF-8">
  <title>@yield('title') - 庄明涵的博客</title>
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <meta name="format-detection" content="telephone=no">
  <meta name="renderer" content="webkit">
  <meta http-equiv="Cache-Control" content="no-siteapp"/>
  <link href="{{ asset('public/css/amazeui.min.css') }}" rel="stylesheet">
  <link rel="alternate icon" type="image/png" href="{{ asset('public/i/favicon.png') }}">
  <style>
    .get {
      background: #1E5B94;
      color: #fff;
  ...
  <div class="am-container">
    ...
    <div class="am-collapse am-topbar-collapse" id="collapse-head">
      <ul class="am-nav am-nav-pills am-topbar-nav">
        ...
        <li><a href="{{ url('/index.php/category/1') }}">博客</a></li>
...
<script src="{{ asset('public/js/amazeui.ie8polyfill.min.js') }}"></script>
<![endif]-->

<!--[if (gte IE 9)|!(IE)]><!-->
<script src="{{ asset('public/js/jquery.min.js') }}"></script>
<!--<![endif]-->
<script src="{{ asset('public/js/amazeui.min.js') }}"></script>
</body>
</html>
